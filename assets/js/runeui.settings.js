         ...
         m('h1', 'Settings'),
             m('fieldset.form-horizontal', [
                 ...
                 m('.form-group', [
                     ...
                     m('.col-sm-10', [
                        // [TODO] re-enable this when the rendering performance issue is solved
             ...
             m('fieldset.form-horizontal[id="features-management"]', [
                 ...
                 m('[id="airplayBox"]', { className: settings.vm.data.features.airplay.enable ? 'boxed-group' : '' }, [
                     m('.form-group', [
                         m('label.control-label.col-sm-2[for="airplay"]', 'AirPlay'),
                         m('.col-sm-10', [
                            mithril.createYesNo('enable', settings.vm.data.features.airplay, 'enable'),
                             m('span.help-block', 'Toggle the capability of receiving wireless streaming of audio via AirPlay protocol')
                         ])
                     ]),
                     m('[id="airplayName"]', { className: settings.vm.data.features.airplay.enable ? '' : 'hide' }, [
                         m('.form-group', [
                 ...
                 m('.form-group.form-actions', [
                     m('.col-sm-offset-2.col-sm-10', [
                         m('button.btn.btn-primary.btn-lg[name="features[submit]"][type="button"]', { onclick: function(e){ settings.vm.save('features'); } }, 'apply settings')
                     ])
                 ])
             ]),
             m('fieldset.form-horizontal', [
