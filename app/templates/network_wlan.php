        ...
        <fieldset>
            ...
            <div class="boxed">
                <table class="info-table">
                    <tbody>
                        <tr><th>Network SSID:</th><td><strong><?=urldecode($this->uri(4)) ?></strong></td></tr> <!--urldecode-->
        ...
        <fieldset>
            <?php if($this->stored !== 1): ?>
                ...
                <div class="form-group <?php if(urldecode($this->uri(4)) !== 'add'): ?>hide<?php endif; ?>">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control input-lg" type="text" id="wifi-ssid" name="nic[ssid]" value="<?php if(urldecode($this->uri(4)) !== 'add'): ?><?=urldecode($this->uri(4)) ?><?php endif; ?>" data-trigger="change" autocomplete="off">
