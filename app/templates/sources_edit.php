    ...
    <form class="form-horizontal" action="/sources/" method="post" role="form" data-parsley-validate>
        ...
        <fieldset id="mount-advanced-config" class="hide">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control osk-trigger input-lg" type="text" id="options" name="mount[options]" value="<?=$this->mount['options']?>" data-trigger="change" autocomplete="off" placeholder="cache=none,ro">
